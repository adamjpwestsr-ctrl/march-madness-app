...
<main className="flex gap-8 px-6 pb-10 items-start">
  {/* Opening Round */}
  <div className="flex-[0.55] space-y-6 rounded-2xl p-5 bg-gradient-to-br from-slate-900/60 to-slate-800/40 backdrop-blur-xl border border-white/10 shadow-xl">
    <OpeningRoundPanel
  ...
  {/* Regions + Finals */}
  <div className="flex-[0.45] space-y-8 rounded-2xl p-5 bg-gradient-to-br from-slate-900/60 to-slate-800/40 backdrop-blur-xl border border-white/10 shadow-xl">
    {/* Regions */}
