...
export async function GET(req: Request) {
  ...
  const formatted = data.map((s: any) => ({
    ...
    home_name: s["mlb_teams!mlb_schedule_home_team_id_fkey"].name,
    home_abbrev: s["mlb_teams!mlb_schedule_home_team_id_fkey"].abbreviation,
    away_name: s["mlb_teams!mlb_schedule_away_team_id_fkey"].name,
    away_abbrev: s["mlb_teams!mlb_schedule_away_team_id_fkey"].abbreviation,
  }));
